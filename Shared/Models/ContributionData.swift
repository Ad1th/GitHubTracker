...
public struct ContributionData: Codable, Equatable {
    ...
    /// Provides realistic mock contribution data for SwiftUI previews and fallback states.
    public static func sample(username: String = "adith") -> ContributionData {
        ...
        // Generate past 52 weeks (364 days)
        let totalDays = 364
        ...
        for i in 0..<totalDays {
            ...
            // Generate pseudo-random realistic pattern (higher on weekdays)
        ...
        for day in days.reversed() {
            if day.count > 0 {
                ...
                // If today is 0 so far, keep checking yesterday
                continue
            } else {
                break
            }
