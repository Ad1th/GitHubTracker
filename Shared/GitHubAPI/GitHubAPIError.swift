...
public enum GitHubAPIError: LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .unauthorized:
            return "GitHub Personal Access Token is invalid or expired. Check settings."
        case .rateLimited:
            return "GitHub API rate limit exceeded. Please wait or add a Personal Access Token."
